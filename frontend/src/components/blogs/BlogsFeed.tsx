                        ...
                        <div className="grow flex flex-col justify-between">
                            <div>
                                ...
                                <p className="text-slate-400 text-sm line-clamp-2 leading-relaxed">
                                    {blog?.content[0]?.content || "No excerpt available."}
                                </p>
                            </div>
                            ...
                            <div className="flex items-center justify-between mt-6">
                                <div className="flex items-center gap-2">
                                    <div className="w-6 h-6 rounded-full bg-slate-800 flex items-center justify-center text-[10px] font-bold text-indigo-400 border border-slate-700">
                                        <img 
                                            src={blog?.userId?.profileImage || '/avatar-placeholder.png'} 
                                            alt={blog?.author} 
                                ...
                                <div className="flex items-center gap-4 text-slate-500">
                                    <span className="flex items-center gap-1.5 text-[11px] font-medium"><Eye size={14} /> {blog?.stats?.views || 0}</span>
                                    <span className="flex items-center gap-1.5 text-[11px] font-medium"><Clock size={14} /> {blog?.stats?.readTime || '5 min'}</span>
                                </div>
                            </div>
                        </div>
                    </article>
