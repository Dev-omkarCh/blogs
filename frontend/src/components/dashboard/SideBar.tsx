...
import { 
  Settings, User, Coffee, Command, Plus, 
  Menu, X, LayoutGrid, LogOut, Sparkles, Moon
} from 'lucide-react';
...
const DashboardLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const menuItems = [
    { id: 'dashboard', label: 'Home', icon: Command },
    { id: 'settings', label: 'Settings', icon: Settings },
    { id: 'preferences', label: 'Theme', icon: Moon },
  ];
    ...
    <div className="flex flex-col lg:flex-row min-h-screen bg-slate-950 text-slate-200">
      ...
      `}>
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="mt-auto mb-6 p-6 rounded-[2rem] bg-amber-500/5 border border-amber-500/10">
